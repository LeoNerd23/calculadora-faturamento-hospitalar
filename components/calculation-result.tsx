                        ...
                        <div className="space-y-2">
                          ...
                          <div className="space-y-1 text-xs">
                            ...
                            <div className="flex justify-between">
                              <span>Cirurgião:</span>
                              <span>
                                {formatCurrency(linha.valorCirurgiao)}
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span>1º Auxiliar:</span>
                              <span>
                                {formatCurrency(linha.valorPrimeiroAuxiliar)}
                              </span>
                            </div>
                            <div className="flex justify-between">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  ...
                  {result.procedimentoPrincipal} {result.descricao}
                </p>
                <p className="text-xs text-blue-600 mt-1">
                  As porcentagens de cada linha são determinadas pelo
                  procedimento principal selecionado.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span>
                  {result.anestesistaEnabled
                    ? formatCurrency(result.valorAnestesista)
                    : "R$ 0,00"}
                </span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {result.quantidadeAuxiliares > 0 && (
                <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-200">
                  ...
                  {Math.round(result.quantidadeAuxiliares) === 1
                    ? "Auxiliar"
                    : "Auxiliares"}
                </Badge>
              )}
