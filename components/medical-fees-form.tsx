            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="codigo" className={errors.codigo ? "text-red-500" : ""}>
                        Código <span className="text-black font-bold">**</span>
                      </Label>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="quantidadePontos" className={errors.quantidadePontos ? "text-red-500" : ""}>
                        Quantidade de Pontos <span className="text-black font-bold">**</span>
                      </Label>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="valorSP" className={errors.valorSP ? "text-red-500" : ""}>
                        Valor SP <span className="text-black font-bold">**</span>
                      </Label>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="valorSH" className={errors.valorSH ? "text-red-500" : ""}>
                        Valor SH <span className="text-black font-bold">**</span>
                      </Label>
                ...
                {multiplosProcedimentosEnabled && (
                  <MultiplosProcedimentos procedimentos={procedimentos} onChange={setProcedimentos} />
                )}
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <div className="flex items-center gap-2 text-blue-800">
                    ...
                    <span className="text-sm font-medium">
                      Os campos marcados com <span className="text-black font-bold">**</span> são obrigatórios e devem
                      ser preenchidos.
                    </span>
                  </div>
                </div>
